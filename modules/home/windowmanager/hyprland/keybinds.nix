  ...
  config = lib.mkIf module.enable {
    wayland.windowManager.hyprland.settings = {
      bind = [
        ...
        "SUPER CTRL,1,workspace,11"
        "SUPER CTRL,2,workspace,12"
        "SUPER CTRL,3,workspace,13"
        "SUPER CTRL,4,workspace,14"
        "SUPER CTRL,5,workspace,15"
        "SUPER CTRL,6,workspace,16"
        "SUPER CTRL,7,workspace,17"

        "SUPER SHIFT CTRL,1,movetoworkspacesilent,11"
        "SUPER SHIFT CTRL,2,movetoworkspacesilent,12"
        "SUPER SHIFT CTRL,3,movetoworkspacesilent,13"
        "SUPER SHIFT CTRL,4,movetoworkspacesilent,14"
        "SUPER SHIFT CTRL,5,movetoworkspacesilent,15"
        "SUPER SHIFT CTRL,6,movetoworkspacesilent,16"
        "SUPER SHIFT CTRL,7,movetoworkspacesilent,17"
